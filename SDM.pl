...
inicio:-
	new(Menu, dialog('Proyect SDM', size(1000,800))),
...
enfermedad('USTED PADECE PAPERAS:
	TRATAMIENTO:
...
enfermedad('USTED PADECE VARICELA:
       TRATAMIENTO:
...
enfermedad('USTED PADECE SARAMPION:
TRATAMIENTO:
...
enfermedad('USTED PADECE ANEMIA:
TRATAMIENTO:
...
enfermedad('USTED PADECE RESFRIADO:
TRATAMIENTO:
...
enfermedad('USTED PADECE INFLUENZA:
TRATAMIENTO:
...
enfermedad('USTED PADECE HEPATITIS B:
TRATAMIENTO:
...
enfermedad('USTED PADECE HEPATITIS C:
TRATAMIENTO:
...
enfermedad('sin resultados, usted no dio la informacion necesaria o suficiente
ERROR!').
...
botones :- lim,
	...
	send(@respl,selection(Enfermedad)),
